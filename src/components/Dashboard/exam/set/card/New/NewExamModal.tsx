...
export default function NewExamModal() {
    ...
    const [answerChoice, setAnswerChoice] = useState<number>(0);
    ...
    return (
        <>
            <button className="btn btn-success font-normal text-white" onClick={onOpenChange}>
                เพิ่มข้อสอบ
            </button>
            <Modal backdrop="blur" isOpen={isOpen} onOpenChange={onOpenChange} size="2xl">
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1 font-normal">เพิ่มข้อสอบ</ModalHeader>
                            <ModalBody>
                                <div className="flex gap-2 items-start">
                                    <textarea className="text-lg outline-none w-full" placeholder="กรอกคำถามที่นี่" value={question} onChange={e => setQuestion(e.target.value)} />
                                </div>
                                <div className="grid grid-cols-2 gap-3 mt-3">
                                    ...
                                    <div className={`p-3 rounded flex gap-2 items-center justify-start ${answerChoice == 1 ? "bg-green-100" : "bg-gray-100"}`}>
                                        ...
                                        <input placeholder="ข้อที่ 1" autoComplete="off" className={`w-full outline-none ${answerChoice == 1 ? "bg-green-100" : "bg-gray-100"}`} name="choice_1" id="choice_1" value={choice_1} onChange={(e) => { setChoice_1(e.target.value) }} />
                                    </div>
                                    ...
                                    <div className={`p-3 rounded flex gap-2 items-center justify-start ${answerChoice == 2 ? "bg-green-100" : "bg-gray-100"}`}>
                                        ...
                                        <input placeholder="ข้อที่ 2" autoComplete="off" className={`w-full outline-none ${answerChoice == 2 ? "bg-green-100" : "bg-gray-100"}`} name="choice_2" id="choice_2" value={choice_2} onChange={(e) => { setChoice_2(e.target.value) }} />
                                    </div>
                                    ...
                                    <div className={`p-3 rounded flex gap-2 items-center justify-start ${answerChoice == 3 ? "bg-green-100" : "bg-gray-100"}`}>
                                        ...
                                        <input placeholder="ข้อที่ 3" autoComplete="off" className={`w-full outline-none ${answerChoice == 3 ? "bg-green-100" : "bg-gray-100"}`} name="choice_3" id="choice_3" value={choice_3} onChange={(e) => { setChoice_3(e.target.value) }} />
                                    </div>
                                    ...
                                    <div className={`p-3 rounded flex gap-2 items-center justify-start ${answerChoice == 4 ? "bg-green-100" : "bg-gray-100"}`}>
                                        ...
                                        <input placeholder="ข้อที่ 4" autoComplete="off" className={`w-full outline-none ${answerChoice == 4 ? "bg-green-100" : "bg-gray-100"}`} name="choice_4" id="choice_4" value={choice_4} onChange={(e) => { setChoice_4(e.target.value) }} />
                                    </div>
                                    ...
                                    {showChioce5 ? (
                                        <div className={`p-3 rounded flex gap-2 items-center justify-start relative ${answerChoice == 5 ? "bg-green-100" : "bg-gray-100"}`}>
                                            ...
                                            <input placeholder="ข้อที่ 5" autoComplete=" off" className={`w-full outline-none ${answerChoice == 5 ? "bg-green-100" : "bg-gray-100"}`} name="choice_5" id="choice_5" value={choice_5} onChange={(e) => { setChoice_5(e.target.value) }} />
                                            <button type="button" onClick={() => { steShowChoice5(false); setChoice_5(""); if (answerChoice == 5) { setAnswerChoice(Number(1)) } }} className="p-2 font-bold flex items-center justify-center absolute -top-1 -right-1 text-xs rounded-full bg-red-500 text-white">
                                                <FaTrash />
                                            </button>
                                        </div>
                                    ) : (
                            ...
                            <ModalFooter className="border-t">
                                ...
                                <Button color="primary" onPress={() => { onClose(); new_exam(); }}>
                                    ยืนยัน
                                </Button>
                            </ModalFooter>
                        </>
